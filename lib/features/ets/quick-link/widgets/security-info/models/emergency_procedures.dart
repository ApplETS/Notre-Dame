...
// Project imports:
import 'package:notredame/features/ets/quick-link/widgets/security-info/models/emergency_procedure.dart';
...
List<EmergencyProcedure> emergencyProcedures(AppIntl intl) => [
      ...
      EmergencyProcedure(
          ...
          detail: 'assets/markdown/${intl.security_gas_leak_detail}'),
      EmergencyProcedure(
