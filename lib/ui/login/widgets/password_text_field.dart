...
class PasswordFormField extends StatefulWidget {
  ...
  const PasswordFormField({super.key, required this.validator, required this.onEditionComplete});
  ...
  Widget build(BuildContext context) => TextFormField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
                icon: Icon(_obscureText ? Icons.visibility : Icons.visibility_off, color: AppPalette.grey.white),
                tooltip:
                    _obscureText ? AppIntl.of(context)!.login_password_show : AppIntl.of(context)!.login_password_hide,
                onPressed: _toggle)),
