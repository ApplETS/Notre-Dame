...
class _FaqViewState extends State<FaqView> {
  ...
  Widget _carousel() => Carousel(
      ...
      children: [
        _questionCard(AppIntl.of(context)!.faq_questions_no_access_title, AppIntl.of(context)!.faq_questions_no_access_description),
        _questionCard(AppIntl.of(context)!.faq_questions_no_grades_title, AppIntl.of(context)!.faq_questions_no_grades_description)
      ],
    );
