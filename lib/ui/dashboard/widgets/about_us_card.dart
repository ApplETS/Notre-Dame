      ...
      children: [
        Align(
          ...
          child: Container(
            ...
            child: Text(AppIntl.of(context)!.card_applets_title, style: Theme.of(context).primaryTextTheme.titleLarge),
          ),
        ),
        Column(
          ...
          children: [
            Container(
              ...
              child: Text(AppIntl.of(context)!.card_applets_text, style: Theme.of(context).primaryTextTheme.bodyMedium),
            ),
            Container(
