...
abstract class Session with _$Session {
  ...
  const factory Session({
    ...
    @JsonKey(name: 'abrege') required String shortName,

    /// Complete name (like Hiver 2020)
    @JsonKey(name: 'auLong') required String longName,
    ...
    /// Courses end date
    @JsonKey(name: 'dateFinCours') required DateTime endDateCourses,

    /// Registration start
    @JsonKey(name: 'dateDebutChemiNot') required DateTime startDateRegistration,

    /// Registration end
    @JsonKey(name: 'dateFinChemiNot') required DateTime deadlineRegistration,

    /// Cancellation with refund start
    @JsonKey(name: 'dateDebutAnnulationAvecRemboursement') required DateTime startDateCancellationWithRefund,

    /// Cancellation with refund end
    @JsonKey(name: 'dateFinAnnulationAvecRemboursement') required DateTime deadlineCancellationWithRefund,
    ...
    @JsonKey(name: 'dateLimitePourAnnulerASEQ') required DateTime deadlineCancellationASEQ,
  }) = _Session;
