...
List<Discovery> discoveryComponents(AppIntl intl) => [
      Discovery(
          ...
          details: [
            intl.discovery_navbar_dashboard_page_details,
            intl.discovery_navbar_dashboard_page_details2
          ]),
      Discovery(
          ...
          details: [
            intl.discovery_navbar_schedule_page_details,
            intl.discovery_navbar_schedule_page_details2
          ]),
      Discovery(
          ...
          details: [
            intl.discovery_navbar_student_page_details
          ]),
      Discovery(
          ...
          details: [
            intl.discovery_navbar_ets_page_details
          ]),
      Discovery(
          ...
          details: [
            intl.discovery_navbar_more_page_details
          ]),
    ];
