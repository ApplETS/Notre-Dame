...
mixin HttpClientMockHelper {
  ...
  static MockClient stubJsonPost(String url, Map<String, dynamic> jsonResponse, [int statusCode = 200]) {
  ...
  static MockClient stubPost(String url, String response, [int statusCode = 200]) {
  ...
  static MockClient stubJsonGet(String url, Map<String, dynamic> jsonResponse, [int statusCode = 200]) {
  ...
  static MockClient stubGet(String url, String response, [int statusCode = 200]) {
    return MockClient((Request r) {
