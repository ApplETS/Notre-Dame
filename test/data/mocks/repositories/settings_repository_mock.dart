...
class SettingsRepositoryMock extends MockSettingsRepository {
  ...
  static void stubGetDashboard(SettingsRepositoryMock mock,
  ...
  static void stubSetString(SettingsRepositoryMock mock, PreferencesFlag flag,
      {bool toReturn = true}) {
  ...
  static void stubGetString(SettingsRepositoryMock mock, PreferencesFlag flag,
  ...
  static void stubGetDynamicString(
      SettingsRepositoryMock mock, PreferencesFlag flag, String key,
      {String toReturn = 'test'}) {
  ...
  static void stubSetBool(SettingsRepositoryMock mock, PreferencesFlag flag,
      {bool toReturn = true}) {
  ...
  static void stubSetInt(SettingsRepositoryMock mock, PreferencesFlag flag,
      {bool toReturn = true}) {
    when(mock.setInt(flag, any)).thenAnswer((_) async => toReturn);
  }

  /// Stub the [locale] function of [mock], when called return [toReturn].
  static void stubLocale(SettingsRepositoryMock mock,
  ...
  static void stubThemeMode(SettingsRepositoryMock mock,
  ...
  static void stubDateTimeNow(SettingsRepositoryMock mock,
