...
class UserRepositoryMock extends MockUserRepository {
  ...
  static void stubAuthenticate(UserRepositoryMock mock, String username, {bool toReturn = true}) {
    when(mock.authenticate(username: username, password: anyNamed('password'))).thenAnswer((_) async => toReturn);
  }
  ...
  static void stubGetPassword(UserRepositoryMock mock, String passwordToReturn) {
  ...
  static void stubGetPasswordException(UserRepositoryMock mock,
      {ApiException exceptionToReturn = const ApiException(prefix: UserRepository.tag)}) {
