...
class CourseRepositoryMock extends MockCourseRepository {
  ...
  static void stubCoursesActivities(CourseRepositoryMock mock, {List<CourseActivity> toReturn = const []}) {
    when(mock.coursesActivities).thenReturn(toReturn);
  }

  /// Stub the getter [sessions] of [mock] when called will return [toReturn].
  static void stubSessions(CourseRepositoryMock mock, {List<Session> toReturn = const []}) {
    when(mock.sessions).thenReturn(toReturn);
  }

  /// Stub the getter [activeSessions] of [mock] when called will return [toReturn].
  static void stubActiveSessions(CourseRepositoryMock mock, {List<Session> toReturn = const []}) {
  ...
  static void stubGetSessions(CourseRepositoryMock mock, {List<Session> toReturn = const []}) {
  ...
  static void stubCourses(CourseRepositoryMock mock, {List<Course> toReturn = const []}) {
  ...
  static void stubGetCourseSummary(CourseRepositoryMock mock, Course courseCalled, {required Course toReturn}) {
