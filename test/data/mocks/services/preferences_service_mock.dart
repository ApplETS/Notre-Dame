...
class PreferencesServiceMock extends MockPreferencesService {
  ...
  static void stubSetInt(PreferencesServiceMock mock, PreferencesFlag flag, {bool toReturn = true}) {
  ...
  /// Stub the answer of [getString] when the [flag] is used.
  static void stubGetInt(PreferencesServiceMock mock, PreferencesFlag flag, {int? toReturn = 1}) {
  ...
  static void stubGetDateTime(PreferencesServiceMock mock, PreferencesFlag flag, {DateTime? toReturn}) {
