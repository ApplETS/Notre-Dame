...
class MonETSAPIClientMock extends MockMonETSAPIClient {
  ...
  static void stubAuthenticateException(MonETSAPIClientMock mock, String username) {
  ...
  /// will be called with this [username]
  static void stubException(MonETSAPIClientMock mock, String username, {Exception? exception}) {
    exception ??= Exception();
    when(mock.authenticate(username: username, password: anyNamed('password'))).thenThrow(exception);
  }
}
