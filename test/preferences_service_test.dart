...
void main() {
  ...
  group("PreferencesService - ", () {
    ...
    group("setters - ", () {
      test("setBool", () async {
        expect(await service.setBool(PreferencesFlag.scheduleCalendarFormat, value: true), isTrue);
      ...
      test("setInt", () async {
        expect(await service.setInt(PreferencesFlag.scheduleCalendarFormat, 1), isTrue);
        expect(sharedPreferences.getInt(PreferencesFlag.scheduleCalendarFormat.toString()), 1);
      });
