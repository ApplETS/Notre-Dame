  ...
  group("ScheduleView - ", () {
    ...
    group("list view", () {
      testWidgets("list view", (WidgetTester tester) async {
          ...
          await tester.runAsync(() async {
            await tester.pumpWidget(localizedWidget(child: DayCalendar(listView: true, controller: CalendarController())));
    ...
    group("calendar view", () {
      testWidgets("calendar view", (WidgetTester tester) async {
        ...
        await tester.runAsync(() async {
          await tester.pumpWidget(localizedWidget(child: DayCalendar(listView: false, controller: CalendarController())));
          await tester.pumpAndSettle();
        });
