  ...
  Map<DateTime, List<EventData>> events = {
    DateTime.now().withoutTime: [
      EventData(
        ...
        startTime: DateTime.now().withoutTime.add(const Duration(hours: 9)),
        endTime: DateTime.now().withoutTime.add(const Duration(hours: 12)),
      ),
      EventData(
        ...
        date: DateTime.now().withoutTime,
        startTime: DateTime.now().withoutTime.add(const Duration(hours: 14)),
        endTime: DateTime.now().withoutTime.add(const Duration(hours: 17)),
      ),
    ],
  };
