...
main() {
  ...
  group("GradesCard - ", () {
    ...
    testWidgets('Has card grades displayed - with no courses',
          ...
          await tester
              .pumpWidget(localizedWidget(child: GradesCard(courses: [], onDismissed: () {}, loading: false)));
    ...
    testWidgets('Has card grades displayed - with courses',
            (WidgetTester tester) async {
          await tester
              .pumpWidget(localizedWidget(child: GradesCard(courses: courses, onDismissed: () {}, loading: false)));
          await tester.pumpAndSettle();
